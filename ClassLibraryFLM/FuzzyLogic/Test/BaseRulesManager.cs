...
namespace ClassLibraryFLM.FuzzyLogic.Test
{
    ...
    public class BaseRulesManager : ITestList<object>
    {
        ...
        public static object TestExam()
        {
            var db = BaseRules.Obj();
            #region Создание переменных
            Variable difficultyLevel = new("Сложность", new(0, 10))
            {
                Universe = new(0, 10),
                Terms = [
                    new("легко", FuncFabric.GetLineZ(2,4)),
                    new("средне", FuncFabric.GetTrapetial(2,4,6,8)),
                    new("сложно", FuncFabric.GetLineS(6,8)),
                ]
            };

            Variable preparationTime = new("Время подготовки", new(0, 10))
            {
                Universe = new(0, 10),
                Terms = [
                    new("мало", FuncFabric.GetLineZ(2,4)),
                    new("средне", FuncFabric.GetTrapetial(2,4,6,8)),
                    new("много", FuncFabric.GetLineS(6,8)),
                ]
            };

            Variable cheatOpportunity = new("Возможность списать", new(0, 10))
            {
                Universe = new(0, 10),
                Terms = [
                    new("мало", FuncFabric.GetLineZ(2,4)),
            ...
            Variable successChance = new("Вероятность сдачи")
            {
                Universe = new(0, 1),
                Terms = [
                new("да", FuncFabric.GetLineZ(0, 0.3)),
            ...
            db.AddLinguisticVariable(difficultyLevel);
            db.AddLinguisticVariable(preparationTime);
            db.AddLinguisticVariable(cheatOpportunity);
            db.AddLinguisticVariable(successChance);
            #endregion
            #region Создание правил

            db.AddRule(new("[Сложность] - [легко] и [Время подготовки] - [мало] и [Возможность списать] - [мало]", "[Вероятность сдачи] - [скорее нет, чем да]"));
            db.AddRule(new("[Сложность] - [легко] и [Время подготовки] - [мало] и [Возможность списать] - [средне]", "[Вероятность сдачи] - [скорее да, чем нет]"));
            db.AddRule(new("[Сложность] - [легко] и [Время подготовки] - [мало] и [Возможность списать] - [много]", "[Вероятность сдачи] - [да]"));

            db.AddRule(new("[Сложность] - [легко] и [Время подготовки] - [средне] и [Возможность списать] - [мало]", "[Вероятность сдачи] - [скорее да, чем нет]"));
            db.AddRule(new("[Сложность] - [легко] и [Время подготовки] - [средне] и [Возможность списать] - [средне]", "[Вероятность сдачи] - [да]"));
            db.AddRule(new("[Сложность] - [легко] и [Время подготовки] - [средне] и [Возможность списать] - [много]", "[Вероятность сдачи] - [да]"));

            db.AddRule(new("[Сложность] - [легко] и [Время подготовки] - [много] и [Возможность списать] - [мало]", "[Вероятность сдачи] - [да]"));
            db.AddRule(new("[Сложность] - [легко] и [Время подготовки] - [много] и [Возможность списать] - [средне]", "[Вероятность сдачи] - [да]"));
            db.AddRule(new("[Сложность] - [легко] и [Время подготовки] - [много] и [Возможность списать] - [много]", "[Вероятность сдачи] - [да]"));

            db.AddRule(new("[Сложность] - [средне] и [Время подготовки] - [мало] и [Возможность списать] - [мало]", "[Вероятность сдачи] - [скорее нет, чем да]"));
            db.AddRule(new("[Сложность] - [средне] и [Время подготовки] - [мало] и [Возможность списать] - [средне]", "[Вероятность сдачи] - [скорее да, чем нет]"));
            db.AddRule(new("[Сложность] - [средне] и [Время подготовки] - [мало] и [Возможность списать] - [много]", "[Вероятность сдачи] - [скорее да, чем нет]"));

            db.AddRule(new("[Сложность] - [средне] и [Время подготовки] - [средне] и [Возможность списать] - [мало]", "[Вероятность сдачи] - [скорее да, чем нет]"));
            db.AddRule(new("[Сложность] - [средне] и [Время подготовки] - [средне] и [Возможность списать] - [средне]", "[Вероятность сдачи] - [да]"));
            db.AddRule(new("[Сложность] - [средне] и [Время подготовки] - [средне] и [Возможность списать] - [много]", "[Вероятность сдачи] - [да]"));

            db.AddRule(new("[Сложность] - [средне] и [Время подготовки] - [много] и [Возможность списать] - [мало]", "[Вероятность сдачи] - [да]"));
            db.AddRule(new("[Сложность] - [средне] и [Время подготовки] - [много] и [Возможность списать] - [средне]", "[Вероятность сдачи] - [да]"));
            db.AddRule(new("[Сложность] - [средне] и [Время подготовки] - [много] и [Возможность списать] - [много]", "[Вероятность сдачи] - [да]"));

            db.AddRule(new("[Сложность] - [сложно] и [Время подготовки] - [мало] и [Возможность списать] - [мало]", "[Вероятность сдачи] - [нет]"));
            db.AddRule(new("[Сложность] - [сложно] и [Время подготовки] - [мало] и [Возможность списать] - [средне]", "[Вероятность сдачи] - [скорее нет, чем да]"));
            db.AddRule(new("[Сложность] - [сложно] и [Время подготовки] - [мало] и [Возможность списать] - [много]", "[Вероятность сдачи] - [скорее да, чем нет]"));

            db.AddRule(new("[Сложность] - [сложно] и [Время подготовки] - [средне] и [Возможность списать] - [мало]", "[Вероятность сдачи] - [скорее нет, чем да]"));
            db.AddRule(new("[Сложность] - [сложно] и [Время подготовки] - [средне] и [Возможность списать] - [средне]", "[Вероятность сдачи] - [скорее да, чем нет]"));
            db.AddRule(new("[Сложность] - [сложно] и [Время подготовки] - [средне] и [Возможность списать] - [много]", "[Вероятность сдачи] - [да]"));

            db.AddRule(new("[Сложность] - [сложно] и [Время подготовки] - [много] и [Возможность списать] - [мало]", "[Вероятность сдачи] - [скорее да, чем нет]"));
            db.AddRule(new("[Сложность] - [сложно] и [Время подготовки] - [много] и [Возможность списать] - [средне]", "[Вероятность сдачи] - [да]"));
            db.AddRule(new("[Сложность] - [сложно] и [Время подготовки] - [много] и [Возможность списать] - [много]", "[Вероятность сдачи] - [да]"));
        ...
        public static object TestWork()
        {
            var db = BaseRules.Obj();
            #region Создание переменных
            Variable salary = new("Зарплата") // в т.р
            {
                Universe = new(0, 100),
                Terms = [
                    new("низкая", FuncFabric.GetLineZ(30, 50)),
                    new("нормальная", FuncFabric.GetTriangle(30,50,70)),
                    new("наивысшая", FuncFabric.GetTriangle(50,70,90)),
                    new("высокая", FuncFabric.GetLineS(70, 90))
                ]
            };
            Variable distance = new("Работники на удалёнке") // в %
            {
                Universe = new(0, 30),
                Terms = [
                    new("низкое", FuncFabric.GetLineZ(5, 10)),
                    new("оптимальное", FuncFabric.GetTrapetial(5,10,15,20)),
                    new("неприемлемое", FuncFabric.GetLineS(15, 20)),
                ]
            };

            Variable rating = new("Рейтинг (отзывы)")
            {
                Universe = new(0, 1),
                Terms = [
                    new("низкий", FuncFabric.GetLineZ(0.25, 0.5)),
                    new("средний", FuncFabric.GetTriangle(0.25, 0.5, 0.75)),
                    new("высокий", FuncFabric.GetTriangle(0.4, 0.6, 0.8)),
                    new("отличный", FuncFabric.GetLineS(0.7, 0.9))
                ]
            };

            Variable descision = new("Решение")
            {
                Universe = new(0, 1),
                Terms = [
                    new("да", FuncFabric.GetLineZ(0, 0.3)),
    ...
    new("нет", FuncFabric.GetLineS(0.7, 1))
            ...
            db.AddLinguisticVariable(salary);
            db.AddLinguisticVariable(distance);
            db.AddLinguisticVariable(rating);
            db.AddLinguisticVariable(descision);
            #endregion

            #region Задание правил
            db.AddRule(new("[Зарплата] - [низкая] и [Работники на удалёнке] - [низкое] и [Рейтинг (отзывы)] - [низкий]", "[Решение] - [скорее да, чем нет]"));
            db.AddRule(new("[Зарплата] - [низкая] и [Работники на удалёнке] - [низкое] и [Рейтинг (отзывы)] - [средний]", "[Решение] - [скорее да, чем нет]"));
            db.AddRule(new("[Зарплата] - [низкая] и [Работники на удалёнке] - [низкое] и [Рейтинг (отзывы)] - [высокий]", "[Решение] - [скорее да, чем нет]"));
            db.AddRule(new("[Зарплата] - [низкая] и [Работники на удалёнке] - [низкое] и [Рейтинг (отзывы)] - [отличный]", "[Решение] - [да]"));
            db.AddRule(new("[Зарплата] - [низкая] и [Работники на удалёнке] - [оптимальное] и [Рейтинг (отзывы)] - [низкий]", "[Решение] - [скорее нет, чем да]"));
            db.AddRule(new("[Зарплата] - [низкая] и [Работники на удалёнке] - [оптимальное] и [Рейтинг (отзывы)] - [средний]", "[Решение] - [скорее да, чем нет]"));
            db.AddRule(new("[Зарплата] - [низкая] и [Работники на удалёнке] - [оптимальное] и [Рейтинг (отзывы)] - [высокий]", "[Решение] - [скорее да, чем нет]"));
            db.AddRule(new("[Зарплата] - [низкая] и [Работники на удалёнке] - [оптимальное] и [Рейтинг (отзывы)] - [отличный]", "[Решение] - [да]"));
            db.AddRule(new("[Зарплата] - [низкая] и [Работники на удалёнке] - [неприемлемое] и [Рейтинг (отзывы)] - [низкий]", "[Решение] - [нет]"));
            db.AddRule(new("[Зарплата] - [низкая] и [Работники на удалёнке] - [неприемлемое] и [Рейтинг (отзывы)] - [средний]", "[Решение] - [нет]"));
            db.AddRule(new("[Зарплата] - [низкая] и [Работники на удалёнке] - [неприемлемое] и [Рейтинг (отзывы)] - [высокий]", "[Решение] - [нет]"));
            db.AddRule(new("[Зарплата] - [низкая] и [Работники на удалёнке] - [неприемлемое] и [Рейтинг (отзывы)] - [отличный]", "[Решение] - [нет]"));
            db.AddRule(new("[Зарплата] - [нормальная] и [Работники на удалёнке] - [низкое] и [Рейтинг (отзывы)] - [низкий]", "[Решение] - [скорее да, чем нет]"));
            db.AddRule(new("[Зарплата] - [нормальная] и [Работники на удалёнке] - [низкое] и [Рейтинг (отзывы)] - [средний]", "[Решение] - [скорее да, чем нет]"));
            db.AddRule(new("[Зарплата] - [нормальная] и [Работники на удалёнке] - [низкое] и [Рейтинг (отзывы)] - [высокий]", "[Решение] - [скорее да, чем нет]"));
            db.AddRule(new("[Зарплата] - [нормальная] и [Работники на удалёнке] - [низкое] и [Рейтинг (отзывы)] - [отличный]", "[Решение] - [да]"));
            db.AddRule(new("[Зарплата] - [нормальная] и [Работники на удалёнке] - [оптимальное] и [Рейтинг (отзывы)] - [низкий]", "[Решение] - [скорее нет, чем да]"));
            db.AddRule(new("[Зарплата] - [нормальная] и [Работники на удалёнке] - [оптимальное] и [Рейтинг (отзывы)] - [средний]", "[Решение] - [скорее да, чем нет]"));
            db.AddRule(new("[Зарплата] - [нормальная] и [Работники на удалёнке] - [оптимальное] и [Рейтинг (отзывы)] - [высокий]", "[Решение] - [скорее да, чем нет]"));
            db.AddRule(new("[Зарплата] - [нормальная] и [Работники на удалёнке] - [оптимальное] и [Рейтинг (отзывы)] - [отличный]", "[Решение] - [скорее да, чем нет]"));
            db.AddRule(new("[Зарплата] - [нормальная] и [Работники на удалёнке] - [неприемлемое] и [Рейтинг (отзывы)] - [низкий]", "[Решение] - [нет]"));
            db.AddRule(new("[Зарплата] - [нормальная] и [Работники на удалёнке] - [неприемлемое] и [Рейтинг (отзывы)] - [средний]", "[Решение] - [нет]"));
            db.AddRule(new("[Зарплата] - [нормальная] и [Работники на удалёнке] - [неприемлемое] и [Рейтинг (отзывы)] - [высокий]", "[Решение] - [нет]"));
            db.AddRule(new("[Зарплата] - [нормальная] и [Работники на удалёнке] - [неприемлемое] и [Рейтинг (отзывы)] - [отличный]", "[Решение] - [нет]"));
            db.AddRule(new("[Зарплата] - [наивысшая] и [Работники на удалёнке] - [низкое] и [Рейтинг (отзывы)] - [низкий]", "[Решение] - [нет]"));
            db.AddRule(new("[Зарплата] - [наивысшая] и [Работники на удалёнке] - [низкое] и [Рейтинг (отзывы)] - [средний]", "[Решение] - [нет]"));
            db.AddRule(new("[Зарплата] - [наивысшая] и [Работники на удалёнке] - [низкое] и [Рейтинг (отзывы)] - [высокий]", "[Решение] - [скорее да, чем нет]"));
            db.AddRule(new("[Зарплата] - [наивысшая] и [Работники на удалёнке] - [низкое] и [Рейтинг (отзывы)] - [отличный]", "[Решение] - [скорее да, чем нет]"));
            db.AddRule(new("[Зарплата] - [наивысшая] и [Работники на удалёнке] - [оптимальное] и [Рейтинг (отзывы)] - [низкий]", "[Решение] - [нет]"));
            db.AddRule(new("[Зарплата] - [наивысшая] и [Работники на удалёнке] - [оптимальное] и [Рейтинг (отзывы)] - [средний]", "[Решение] - [нет]"));
            db.AddRule(new("[Зарплата] - [наивысшая] и [Работники на удалёнке] - [оптимальное] и [Рейтинг (отзывы)] - [высокий]", "[Решение] - [скорее нет, чем да]"));
            db.AddRule(new("[Зарплата] - [наивысшая] и [Работники на удалёнке] - [оптимальное] и [Рейтинг (отзывы)] - [отличный]", "[Решение] - [скорее нет, чем да]"));
            db.AddRule(new("[Зарплата] - [наивысшая] и [Работники на удалёнке] - [неприемлемое] и [Рейтинг (отзывы)] - [низкий]", "[Решение] - [нет]"));
            db.AddRule(new("[Зарплата] - [наивысшая] и [Работники на удалёнке] - [неприемлемое] и [Рейтинг (отзывы)] - [средний]", "[Решение] - [нет]"));
            db.AddRule(new("[Зарплата] - [наивысшая] и [Работники на удалёнке] - [неприемлемое] и [Рейтинг (отзывы)] - [высокий]", "[Решение] - [нет]"));
            db.AddRule(new("[Зарплата] - [наивысшая] и [Работники на удалёнке] - [неприемлемое] и [Рейтинг (отзывы)] - [отличный]", "[Решение] - [нет]"));
            db.AddRule(new("[Зарплата] - [высокая] и [Работники на удалёнке] - [низкое] и [Рейтинг (отзывы)] - [низкий]", "[Решение] - [нет]"));
            db.AddRule(new("[Зарплата] - [высокая] и [Работники на удалёнке] - [низкое] и [Рейтинг (отзывы)] - [средний]", "[Решение] - [нет]"));
            db.AddRule(new("[Зарплата] - [высокая] и [Работники на удалёнке] - [низкое] и [Рейтинг (отзывы)] - [высокий]", "[Решение] - [нет]"));
            db.AddRule(new("[Зарплата] - [высокая] и [Работники на удалёнке] - [низкое] и [Рейтинг (отзывы)] - [отличный]", "[Решение] - [нет]"));
            db.AddRule(new("[Зарплата] - [высокая] и [Работники на удалёнке] - [оптимальное] и [Рейтинг (отзывы)] - [низкий]", "[Решение] - [нет]"));
            db.AddRule(new("[Зарплата] - [высокая] и [Работники на удалёнке] - [оптимальное] и [Рейтинг (отзывы)] - [средний]", "[Решение] - [нет]"));
            db.AddRule(new("[Зарплата] - [высокая] и [Работники на удалёнке] - [оптимальное] и [Рейтинг (отзывы)] - [высокий]", "[Решение] - [нет]"));
            db.AddRule(new("[Зарплата] - [высокая] и [Работники на удалёнке] - [оптимальное] и [Рейтинг (отзывы)] - [отличный]", "[Решение] - [нет]"));
            db.AddRule(new("[Зарплата] - [высокая] и [Работники на удалёнке] - [неприемлемое] и [Рейтинг (отзывы)] - [низкий]", "[Решение] - [нет]"));
            db.AddRule(new("[Зарплата] - [высокая] и [Работники на удалёнке] - [неприемлемое] и [Рейтинг (отзывы)] - [средний]", "[Решение] - [нет]"));
            db.AddRule(new("[Зарплата] - [высокая] и [Работники на удалёнке] - [неприемлемое] и [Рейтинг (отзывы)] - [высокий]", "[Решение] - [нет]"));
            db.AddRule(new("[Зарплата] - [высокая] и [Работники на удалёнке] - [неприемлемое] и [Рейтинг (отзывы)] - [отличный]", "[Решение] - [нет]"));
            #endregion
            return new();
        }
    }
