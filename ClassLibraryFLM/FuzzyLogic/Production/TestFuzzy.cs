...
namespace ClassLibraryFLM.FuzzyLogic.Production
{
    public class TestFuzzy
    {
        ...
        public static void TestCar()
        {
            ...
            cost = db.AddLinguisticVariable(cost);
            expenses = db.AddLinguisticVariable(expenses);
            reliability = db.AddLinguisticVariable(reliability);
            solution = db.AddLinguisticVariable(solution);
            #endregion
            ...
            Output.Calc(inputs, solution);
            TestEnd("выбор машины");
        }
        ...
        public static void TestWater()
        {
            ...
            liquidLevel = db.AddLinguisticVariable(liquidLevel);
            liquidConsumption = db.AddLinguisticVariable(liquidConsumption);
            liquidFlow = db.AddLinguisticVariable(liquidFlow);
            #endregion
